...
#
html_theme_options = {
    u'description': u'%s package.' % metadata.__project__,
    u'fixed_sidebar': True,
    u'github_button': True,
    u'github_repo': u'python-barcode',
    u'github_user': u'steenzout',
...
htmlhelp_basename = 'py_steenzout_barcode'
...
latex_documents = [(
    master_doc,
    'py_steenzout_barcode.tex',
    u'%s documentation' % metadata.__project__,
    metadata.__author__,
    'manual'
)]
...
man_pages = [(
    master_doc,
    'py_steenzout_barcode',
    '%s documentation' % metadata.__project__,
    [metadata.__author__],
    1
)]
